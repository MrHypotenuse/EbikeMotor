...
const PROFS = {
  ...
  inline6: {
    idle: 900, max: 9500,
    sample: 'inline6.mp3', sampleLo: 0.5, sampleHi: 1.85, sampleGain: 1.7, sampleSub: 0.32, loopPos: 0.4, loopLen: 0.1,
  ...
  twostroke: {
    idle: 1200, max: 9500,
    sample: 'twostroke.mp3', sampleLo: 0.7, sampleHi: 2.4, sampleGain: 1.8, sampleSub: 0.10, loopPos: 0.4, loopLen: 0.08,
